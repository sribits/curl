...
ACLOCAL = ${SHELL} "/home/smalik/Downloads/arm/curl/curl-7.23.1/missing" --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} "/home/smalik/Downloads/arm/curl/curl-7.23.1/missing" --run tar
AR = /home/smalik/arm-gcc/opt/FriendlyARM/toolschain/4.4.3/bin/arm-linux-ar
AS = as
AUTOCONF = ${SHELL} "/home/smalik/Downloads/arm/curl/curl-7.23.1/missing" --run autoconf
AUTOHEADER = ${SHELL} "/home/smalik/Downloads/arm/curl/curl-7.23.1/missing" --run autoheader
AUTOMAKE = ${SHELL} "/home/smalik/Downloads/arm/curl/curl-7.23.1/missing" --run automake-1.9
AWK = gawk
...
CONFIGURE_OPTIONS = " '--host=arm-linux' '--prefix=/home/smalik/arm-gcc/opt/FriendlyARM/toolschain/4.4.3/' 'host_alias=arm-linux'"
CPP = arm-linux-gcc -E
CPPFLAGS = 
...
MAKEINFO = ${SHELL} "/home/smalik/Downloads/arm/curl/curl-7.23.1/missing" --run makeinfo
MANIFEST_TOOL = :
MANOPT = -man
MIMPURE_FALSE = 
MIMPURE_TRUE = #
...
PACKAGE_URL = 
PACKAGE_VERSION = -
PATH = /home/smalik/Downloads/firefox:/home/smalik/Downloads/jazz/scmtools/eclipse:/home/smalik/Downloads/firefox:/home/smalik/Downloads/jazz/scmtools/eclipse:/usr/local/bin:/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/sbin:/opt/lodev3.5//program:/opt/ibm/c4eb/bin:/home/smalik/bin:/usr/kerberos/bin:/home/smalik/arm-gcc/opt/FriendlyARM/toolschain/4.4.3/bin
PATH_SEPARATOR = :
PERL = /usr/bin/perl
...
install_sh = /home/smalik/Downloads/arm/curl/curl-7.23.1/install-sh
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/. $(distdir)/CMake $(distdir)/CMake/Platforms $(distdir)/include/curl $(distdir)/m4 $(distdir)/packages/AIX/RPM $(distdir)/packages/EPM $(distdir)/packages/Linux/RPM $(distdir)/winbuild
